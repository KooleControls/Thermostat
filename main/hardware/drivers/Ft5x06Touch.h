...
// ──────────────────────────────────────────────────────────────
// Reusable driver — FocalTech FT5x06 family (incl. FT6336U) capacitive touch
// over I2C. Bus-agnostic; the board supplies bus, resolution, reset/INT pins
// and any rotation flags. The board wraps this in its own `Touch` class.
//
// x_max/y_max are the NATIVE (pre-rotation) panel extents; swap_xy/mirror flags
// rotate raw coordinates into the displayed frame so touch lines up.
//
