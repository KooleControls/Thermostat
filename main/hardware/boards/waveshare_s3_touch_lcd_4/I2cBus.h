...
// ──────────────────────────────────────────────────────────────
// Shared I2C master bus for the Waveshare ESP32-S3-Touch-LCD-4.
//
// The GT911 touch controller and the CH32V003 IO expander sit on the same
// SDA/SCL pins, so the bus must be created exactly once and shared. This lazy
// singleton lets each driver (Display/Touch) keep its no-arg Init() and just
// ask for the bus, without a board-wide init-order contract.
// ──────────────────────────────────────────────────────────────
