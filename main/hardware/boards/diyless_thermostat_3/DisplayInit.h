...
#include "esp_lcd_st7701.h"   // st7701_lcd_init_cmd_t

// Panel-specific ST7701S init sequence for the DIYLESS Thermostat 3, transcribed
// from the ESPHome st7701s component default sequence #1 (the one DIYLESS relies
// on). The esp_lcd driver's generic default does NOT match this panel (vertical
// banding); these BK0/BK1/BK3 values are what lock it. Consumed by Board.cpp.
